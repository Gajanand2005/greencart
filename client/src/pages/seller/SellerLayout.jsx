...
const SellerLayout = () => {
  ...
  return (
       <>
            <div className="flex items-center justify-between px-4 md:px-8 border-b text-black border-gray-300 py-3 bg-white ">
                <Link to='/' >
            ...
            <div className='flex'>
            <div className="md:w-64 w-16 border-r h-[95vh] text-black border-gray-300 pt-4 flex flex-col ">
